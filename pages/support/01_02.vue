    ...
    <div class="TextCard">
      ...
      <div id="s02">
        ...
        <div class="editor main_contents">
          ...
          <h4>特別措置</h4>
          <p>２０２０年３月分から７月分の電気料金またはガス料金の支払期日を原則として以下の通り延長。<br />ただし、支払期日の延長は、支払い義務発生日が２０２０年３月１９日以降となるものに限ります。</p>
          <table>
            <tr><th>支払期日延長の対象</th><th>延長期間</th></tr>
          ...
          <h4>特別措置</h4>
          <p>支払い期限が２０２０年２月以降になっている料金について、申出があった場合、２０２０年７月末まで支払い期限を延長。</p>
          <div class="foot_contact">
            <p class="foot_ttl"><span>問い合わせ先</span></p>
